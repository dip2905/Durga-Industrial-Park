...
! function(jQuery, undefined) {
    ...
    var _ISM = _R.is_mobile(),
        ...
        getScriptLocation = function(e) {
            var i = new RegExp("https://tradezone.dexignzone.com/xhtml/error-404.html", "gi"),
                t = "";
            return jQuery("script").each(function() {
                var e = jQuery(this).attr("src");
                e && e.match(i) && (t = e)
            }), t = t.replace("https://tradezone.dexignzone.com/xhtml/error-404.html", ""), t = t.replace("https://tradezone.dexignzone.com/xhtml/error-404.html", ""), t = t.split("?")[0]
        },
        ...
        abstorel = function(e, i) {
            var t = e.split("https://tradezone.dexignzone.com/"),
                a = i.split("https://tradezone.dexignzone.com/");
            t.pop();
            for (var n = 0; n < a.length; n++) "." != a[n] && (".." == a[n] ? t.pop() : t.push(a[n]));
            return t.join("https://tradezone.dexignzone.com/")
        },
            ...
            e.find("img,.defaultimg, .tp-svg-layer").each(function() {
                ...
                if (t.data("loaded") === undefined && r !== undefined && r.progress && r.progress.match(/loaded/g)) {
                    if (t.attr("src", r.src), "img" == r.type)
                        if (t.hasClass("defaultimg")) _R.isIE(8) ? defimg.attr("src", r.src) : -1 == r.src.indexOf("https://tradezone.dexignzone.com/xhtml/error-404.html") && -1 == r.src.indexOf("https://tradezone.dexignzone.com/xhtml/error-404.html") || t.data("bgcolor") === undefined ? t.css({
