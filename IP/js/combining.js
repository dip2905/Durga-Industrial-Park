...
!(function (t, e) {
	"object" == typeof exports && "undefined" != typeof module
		? e(
				exports,
				require("jquery"),
				require("https://tradezone.dexignzone.com/xhtml/error-404.html")
		  )
		: "function" == typeof define && define.amd
	...
	var e = $(window).width(),
		...
		n = function () {
			...
			e.css("display", "block"),
				i.css(
					"margin-top",
					Math.max(0, (jQuery(window).height() - i.height()) / 2)
				);
		},
		r = function () {
			"use strict";
